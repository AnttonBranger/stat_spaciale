...
```{r}
dbGetQuery(conn, "SELECT * FROM bpe_metro INNER JOIN popnaiss_com BY codgeo WHERE codgeo='35047'")
```
...
```{r}
cinema_1km_sorbonne <- st_within(x = cinema_bpe, y = sorbonne_buffer)
